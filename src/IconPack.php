...
final class IconPack
{
    ...
    public static function get( string $icon, ?string $fallback = null ) : ?string {
        return IconPack::getInstance()->getIcon( $icon, $fallback );
    }

    public function getIcon( string $icon, ?string $fallback ) : ?string {
